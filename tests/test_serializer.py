...
@pytest.mark.parametrize(("inp", "expected"), [
    ({"methodCall": {"methodName": "test"}}, b"<methodCall><methodName>test</methodName></methodCall>"),
    ({"methodCall": {"methodName": "test", "params": []}}, b"<methodCall><methodName>test</methodName><params/></methodCall>"),
    (
        {
            "methodCall": {
                "methodName": "test",
...
def test_serialize_deserialize(inp, expected):
    s = Serializer()
